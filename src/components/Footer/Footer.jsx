    ...
    <footer className="bg-base-200 pt-20 pb-10 border-t border-base-300">
      <div className=" mx-auto pl-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
              ...
              {[FiFacebook, FiTwitter, FiInstagram, FiLinkedin].map(
                (Icon, idx) => (
                  <a
                    key={idx}
                    href="#"
                    className="w-10 h-10 rounded-full bg-base-300 flex items-center justify-center text-base-content/60 hover:bg-blue-600 hover:text-white transition-all duration-300"
                  >
                    <Icon size={18} />
                  </a>
                ),
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-base-content font-semibold text-lg mb-6">
              Quick Links
            </h3>
