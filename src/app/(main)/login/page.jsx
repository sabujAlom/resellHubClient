...
const LoginForm = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center bg-base-200 px-6 py-12 w-full"
    >
      <div className="card w-full max-w-md bg-base-100 border border-base-300 shadow-2xl p-8 space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-500">
            Welcome Back
          </h2>
          <p className="text-xs text-slate-400">Sign in to list items, place orders, or review sellers</p>
        </div>
          ...
          <div className="form-control">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="input input-bordered w-full pl-12 bg-base-200 text-base-content"
                required
              />
            </div>
          </div>
        ...
        <div className="divider text-xs text-slate-500">OR CONTINUE WITH</div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-base-200">Loading form...</div>}>
      <LoginForm />
    </Suspense>
  );
}
